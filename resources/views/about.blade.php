...
@section('title', 'About Us - RockView Kenya')
	...
	<div class="container">
		<div class="row align-items-center g-5">
			<div class="col-lg-6" data-aos="fade-right">
				...
				<p>
					RockView began as a dream to share Kenya's incredible beauty with the world.
...
<section class="tt-section">
	<div class="container">
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<h2 class="tt-title">Why Choose <span class="accent">RockView</span></h2>
